...
class BaseWalkK1(BaseTask):
    ...
    def _create_envs(self):
        ...
        # Override effort limits from config if specified
        ...
        # Override velocity limits from config if specified
        ...
        # Set per-joint armature values from config
    ...
    def step(self, actions):
        ...
        # Calculate dof_vel from positions
